    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-black text-primary mb-1">Offices</h1>
                ...
                <button onClick={() => { setEditOffice(null); setShowForm(true); }}
                    className="flex items-center gap-2 bg-primary text-white hover:-translate-y-0.5 px-5 py-3 rounded-xl text-sm font-black transition-all">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div key={o.id} className="glass-card bg-white/60 border border-white p-6 hover:-translate-y-1 transition-all group flex flex-col justify-between h-full relative overflow-hidden">
                        ...
                        <div className="flex gap-3 pt-4 border-t border-gray-200/50 relative z-10">
                            <button onClick={() => { setEditOffice(o); setShowForm(true); }}
                                className="flex-1 bg-white hover:bg-gray-50 border border-gray-200 flex items-center justify-center gap-2 text-primary hover:text-accent py-2.5 rounded-xl text-sm font-bold transition-all">
                                <Pencil size={15} /> Edit
                            </button>
                ...
                {offices.length === 0 && (
                    <div className="sm:col-span-2 lg:col-span-3 glass-card p-12 text-center border-dashed border-2 border-primary/20 bg-primary/5 cursor-pointer hover:bg-primary/10 transition-colors" onClick={() => { setEditOffice(null); setShowForm(true); }}>
                        ...
                        <button className="bg-primary text-white font-bold px-6 py-2.5 rounded-xl transition-all inline-flex items-center gap-2 text-sm">
