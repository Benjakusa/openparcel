        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4">
            ...
            <div className="relative z-10 w-full max-w-sm animate-fadeIn">
                ...
                <div className="glass-card p-6 space-y-4">
                    <p className="text-xs font-normal text-slate-400 uppercase tracking-widest text-center mb-2">
                        Get started
                    </p>
                    ...
                    <Link
                        to="/login"
                        className="flex items-center justify-between w-full bg-slate-900 hover:bg-blue-700 text-white px-5 py-4 rounded-xl font-normal text-sm transition-all hover:-translate-y-0.5 group"
                    >
                    ...
                    <Link
                        to="/register"
                        className="flex items-center justify-between w-full border border-slate-200 hover:border-blue-300 hover:bg-blue-50 text-slate-800 px-5 py-4 rounded-xl font-normal text-sm transition-all hover:-translate-y-0.5 group"
                    >
                        <div className="flex items-center gap-3">
