        ...
        return (
            <div className="min-h-[90vh] bg-transparent flex items-center justify-center p-4">
                <div className="glass-card p-10 w-full max-w-md text-center animate-fadeIn">
                    ...
                    <h2 className="text-base font-semibold text-primary mb-3">Check Your Email</h2>
                    ...
                    <Link to="/login" className="text-accent font-normal hover:underline">Back to login</Link>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-[90vh] bg-transparent flex items-center justify-center p-4">
            <div className="w-full max-w-md animate-fadeIn mt-8 mb-12">
                ...
                <div className="glass-card p-8">
                    <h2 className="text-base font-semibold text-primary mb-2">Reset Password</h2>
                    <p className="text-sm text-gray-500 mb-6">Enter your email and we'll send you a reset link.</p>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="block text-sm font-normal text-primary mb-1.5">Email</label>
                    ...
                    <p className="text-center text-sm text-gray-500 mt-6">
                        <Link to="/login" className="text-accent font-normal hover:underline inline-flex items-center gap-1">
